...
/**
 * @ author：mo
 * @ data：2019/5/28:17:58
 * @ 功能：应用分身检查
 */
public class AppSeparationActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.testd);
//        LogUtil.i( (int) BengUtil.getData(this,2)+"");
        Object data = BengUtil.getData(this);
        LogUtil.i(data+"");
        LogUtil.i(BengUtil.getExtras(this).getBoolean("extra",false)+"");
...
//                forTest();
            ...
            case R.id.checkDebuggerAttach:
                ...
                d2.setText(SecurityCheckUtil.getSingleInstance().checkIsUsbCharging(AppSeparationActivity.this) ?
            ...
            case R.id.readSysProperty:
                final TextView e1 = findViewById(R.id.e1);
