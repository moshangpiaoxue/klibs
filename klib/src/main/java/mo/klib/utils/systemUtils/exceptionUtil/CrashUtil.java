...
public final class CrashUtil {
    ...
    static {
        try {
            PackageInfo pi = k.app()
                    .getPackageManager()
                    .getPackageInfo(k.app().getPackageName(), 0);
            if (pi != null) {
    ...
    public static void init(final String crashDir) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && k.app().getExternalCacheDir() != null)
            defaultDir = k.app().getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = k.app().getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
