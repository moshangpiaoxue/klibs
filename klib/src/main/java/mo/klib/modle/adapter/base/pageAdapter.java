package mo.klib.modle.adapter.base;
...
*/
public abstract class pageAdapter<T> extends PagerAdapter {
    protected List<T> mDatas;
    protected Context context;
    protected int layoutId;

    public pageAdapter(Context context, List<T> mDatas, int layoutId) {
        this.mDatas = mDatas;
    ...
    protected abstract View doWhat(ViewGroup container, View view, int position);
