...
public class KCalendar extends ViewFlipper implements
	...
	public static final int COLOR_TX_WEEK_TITLE = Color.parseColor("#ff666666"); // 星期标题文字颜色
...
//	private float tb;
	...
	private String[] weekday = new String[] { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" }; // 星期标题
...
//		tb = res.getDimension(R.dimen.historyscore_tb);
		...
		for (int i = 0; i < ROWS_TOTAL; i++) {
			...
			for (int j = 0; j < COLS_TOTAL; j++) {
				...
				col.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
...
//							view.setTextColor(Color.WHITE);
							int id = dayBgColorMap.get(dates[i][j]);
							view.setBackgroundResource(id);
//							if(id == R.drawable.shape_blue_half_circle_left
//									|| id == R.drawable.shape_red_half_circle_left
//									|| id == R.drawable.shape_green_half_circle_left ){
//								group.setPadding(12, 12, 0, 12);
//							}else if(id == R.drawable.shape_blue_half_circle_right
//									|| id == R.drawable.shape_red_half_circle_right
//									|| id == R.drawable.shape_green_half_circle_right){
//								group.setPadding(0, 12, 12, 12);
//							}else if(id == R.drawable.shape_blue_rectangle
//									|| id == R.drawable.shape_red_rectangle
//									|| id == R.drawable.shape_green_rectangle){
//								group.setPadding(0, 12, 0, 12);
//							}else{
//								group.setPadding(8, 12, 8, 12);
							group.setPadding(0, 12, 0, 12);
//							}
						}
						// 设置标记
